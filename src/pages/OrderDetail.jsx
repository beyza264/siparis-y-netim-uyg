  ...
  useEffect(() => {
    api
      ...
      .catch((error) => {
        ...
        alert(
          "Sipariş detayları alınırken hata oluştu. Lütfen tekrar deneyiniz.",
        );
        setLoading(false);
      });
  }, [id]);
  ...
  const handleUpdateStatus = () => {
    api
      ...
      .catch((err) => {
        ...
        alert(
          "Sipariş durumu güncellenirken hata oluştu. Lütfen tekrar deneyiniz.",
        );
      });
  };
    ...
    <div className="orders-page">
      <div className="orders-header">
        <div>
          ...
          >
            Sipariş detaylarını görüntüleyin ve yönetin
          </p>
        </div>
        <Link
          to="/orders"
